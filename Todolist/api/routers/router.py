...
async def create_item(collection_name: str, payload:Union [createItems , createScheduleModel , Task] ):
...
async def update_item(collection_name: str, item_id: str, payload:Union[updateItems , updateScheduleModel,updatetask]):
